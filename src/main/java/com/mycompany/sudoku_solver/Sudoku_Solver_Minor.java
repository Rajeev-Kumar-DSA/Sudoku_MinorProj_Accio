 ...
 * @author RAJEEV
 */
public class Sudoku_Solver_Minor extends javax.swing.JFrame {
    
    // currently secltionButton has been clicked or not -> 
    private String turn = "1";
    
    private boolean globalFlag = true;  // it will help to 
    
    
    // I will take one predefine 2D array -> here I will store correct answer
    // this array will help to compare with corrent answer
    ...
    private void AssignTurn(JButton btn){
        selectionbutton1.setBackground(black);   // this will default set the color
    ...
    private void ResetGame(){
        // which grid already filled
        JButton predefinedBtns[] = {r2c1, r3c1, r3c3, r1c4, r2c5, r2c6, r3c5, r1c7, r1c8, r1c9, 
                                    r2c7, r2c9, r3c8, r5c2, r5c3, r6c2, r4c5, r4c6, r6c4, r6c5, r4c8, 
                                    r5c8, r5c7, r7c2, r8c1, r9c1, r9c2, r9c3, r7c5, r8c5, r9c6, 
                                    r8c4, r7c7, r7c9, r8c9};
        // store total button 
        JButton btns[][] ={
        ...
        for(int i=0; i<9; i++){
            for(int j=0; j<9; j++){
                boolean localFlag = true;   /// with help of this variable I will check its predefine ot not
                
                // iterate predeine 1D array
                for(int k=0; k<predefinedBtns.length; k++){
                    // check predeine or not
                    if(btns[i][j] == predefinedBtns[k]){
                        localFlag = false;   // means predine is present for this grid
                    }
                }
                if(localFlag == true){   // when predefine grid will not filled previously
                    btns[i][j].setText("");
...
//        we will check the grid is filled or not -> when filled then check its correct or not
        if(globalFlag == true){
            // it means I clicked show solution button
            globalFlag = false;
            ...
            for(int i=0; i<9; i++){
                for(int j=0; j<9; j++){
                    ...
                    if(flag == true){
                        // that particular grid is not a predefine
            ...
            globalFlag = true;
            ResetGame();   // after seeing the solve -> start new again
        }
    }
    
    private void checkMovesCorrectOrNot(){
        // store total button 
        JButton btns[][] ={
            {r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9},
            {r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9},
        ...
        for(int i=0; i<9; i++){
            for(int j=0; j<9; j++){
                // check value equal to solved arra or not
    ...
    /**
     * Creates new form Sudoku_Solver_Minor
     */
    public Sudoku_Solver_Minor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        checkMoveButton = new javax.swing.JButton();
        ...
        jPanel1.setBackground(new java.awt.Color(255, 233, 243));
        ...
        jPanel2.setBackground(new java.awt.Color(255, 233, 243));
        ...
        jPanel3.setBackground(new java.awt.Color(255, 233, 243));
        ...
        jPanel4.setBackground(new java.awt.Color(255, 233, 243));
        ...
        jPanel6.setBackground(new java.awt.Color(255, 233, 243));
        ...
        jPanel7.setBackground(new java.awt.Color(255, 233, 243));
        ...
        jPanel8.setBackground(new java.awt.Color(255, 233, 243));
        ...
        jPanel9.setBackground(new java.awt.Color(255, 233, 243));
        ...
        jPanel10.setBackground(new java.awt.Color(255, 233, 243));
        ...
        solutionButton.setBackground(new java.awt.Color(102, 255, 102));
        solutionButton.setText("Solution");
        ...
        checkMoveButton.setBackground(new java.awt.Color(255, 255, 102));
        checkMoveButton.setText("Check Moves");
        checkMoveButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                checkMoveButtonActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(selectionbutton1, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(selectionbutton2, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(resetButton))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(selectionbutton3, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(selectionbutton4, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(selectionbutton5, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(selectionbutton6, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(selectionbutton7, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(selectionbutton8, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(selectionbutton9, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(20, 20, 20)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(solutionButton, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(checkMoveButton, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void r1c1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_r1c1ActionPerformed
        // TODO add your handling code here:
        // I will check button is empty or not
        // whatever value will in trun variable -> inside my turn variable. just I will keep it as
        r1c1.setText(turn);
        // now I will change the background color ->
    ...
    private void r8c2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_r8c2ActionPerformed
        // TODO add your handling code here:
        r8c2.setText(turn);  // turn me jo value hoga wahi value set hoga for this button
    ...
    private void selectionbutton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectionbutton1ActionPerformed
        // TODO add your handling code here:
        // here I will override the turn variable -> 
    ...
    private void exitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitButtonActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(frame, "Confirm if you want to Exit", "Sudoku Puzzle", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_NO_OPTION) {
            System.exit(0);  // exit the out screeen
        }
    }//GEN-LAST:event_exitButtonActionPerformed

    private void checkMoveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkMoveButtonActionPerformed
        // TODO add your handling code here:
        checkMovesCorrectOrNot();
    }//GEN-LAST:event_checkMoveButtonActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sudoku_Solver_Minor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sudoku_Solver_Minor().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton checkMoveButton;
